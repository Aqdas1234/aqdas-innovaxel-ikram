...
from .views import ShortenURLView, ShortURLDetailUpdateDeleteView,  ShortURLStatsView
...
urlpatterns = [
    ...
    path('shorten/<str:shortCode>/stats/', ShortURLStatsView.as_view(), name='short-url-stats'),
